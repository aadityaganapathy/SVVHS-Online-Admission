<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewForm.aspx.cs" Inherits="OnlineAdmission.NewForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%--Custom Inline Style Sheet Start--%>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    <div class="wizard-container">
            ...
            <div>
                <a href="Admission.aspx"> <h2><label runat="server" id="lblErrorText" style="color:red" visible="false"></label></h2>   </a>                     
            </div> <%--LBL to display Error for duplicate Entry--%>
            ...
            <div class="row setup-content" id="step-4">
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="40" pattern=".{1,40}" title="Input Invalid"  type="text" required="required" class="form-control-disable" placeholder="Enter Name of the Related Student" id="txtRelatedStudentName" runat="server"/>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Section</label><br />
                            <input type="radio" value="Primary" id="chkPrimary" class="form-control-disable-RBTN" runat="server" name="Section"  required="required" /> <label class="control-label">Primary</label><br />
                            <input type="radio" value="Secondary" id="chkSecondary" class="form-control-disable-RBTN" runat="server" name="Section"  required="required" /> <label class="control-label">Secondary</label>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Standard</label>
                            <input maxlength="10" type="text" required="required" class="form-control-disable" placeholder="Enter Standard of the Related Student" id="txtStandard" runat="server"/>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Division</label>
                            <input maxlength="1" type="text" required="required" class="form-control-disable" placeholder="Enter Division of the Related Student" id="txtDivision" runat="server"/>
                        </div>
        ...
        <script type="text/javascript">
            ...
            });//Hide other headers on page load
            ...
            });//Validates and moves to next step in wizard
            ...
            });//disables certain control on selection of radio option
            ...
            });//Checks input for text box of type number
